  ...
  public: {
    Tables: {
      ...
      content_translations: {
        ...
        Insert: Omit<
          Database["public"]["Tables"]["content_translations"]["Row"],
          "id" | "created_at"
        >;
        Update: Partial<
      ...
      static_page_translations: {
        ...
        Insert: Omit<
          Database["public"]["Tables"]["static_page_translations"]["Row"],
          "id" | "created_at"
        >;
        Update: Partial<
          Database["public"]["Tables"]["static_page_translations"]["Insert"]
        >;
      };
      platform_settings: {
        Row: {
