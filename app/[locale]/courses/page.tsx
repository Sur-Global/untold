    ...
    <>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 py-16">
        <div className="mb-12">
          ...
          <p className="text-[#6B5F58]">Structured learning from Global South practitioners.</p>
        </div>
        ...
        {items && items.length > 0 ? (
              ...
              {items.map((item: any) => {
                ...
                return (
                  <ContentCard
                    ...
                    duration={item.course_meta?.duration}
          ...
          <p className="text-center py-20 text-[#6B5F58]">No courses yet.</p>
        )}
      </main>
      <Footer />
    </>
